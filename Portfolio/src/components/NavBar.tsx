                ...
                <Container>
                    ...
                    <Navbar.Collapse id="basic-navbar-nav">
                        <Nav className="me-auto">
                            ...
                            <Nav.Link href="#add-info" className={activeLink === 'add-info' ?
                                'active navbar-link' : 'navbar-link'} onClick={() => onUpdateActiveLink('add-info')}>Additional Information</Nav.Link>
                        </Nav>
