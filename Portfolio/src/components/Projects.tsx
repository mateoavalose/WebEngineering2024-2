  ...
  const projects = [
    ...
    },
    {
      ...
      description: "For this project, I'm working alongside the Simulators Laboratory at my university. The goal is to predict the \
        amount of oxygen and carbon dioxide inside the alveoli by just measuring the amount of oxygen and carbon dioxide in the mouth.",
      imgUrl: projImg2,
    },
    {
      ...
      for a considerable time now, we're now preparing a presentation for an upcoming event.",
      imgUrl: projImg3,
    },
  ];
