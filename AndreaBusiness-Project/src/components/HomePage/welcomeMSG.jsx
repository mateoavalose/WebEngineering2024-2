...
const WelcomeMsg = () => {
    return (
        <div>
            ...
            <h3>Whether you're here for the makeup that defines your look, the models that bring it to life, or the world-class events that set the trends, 
                remember: this is a place where luxury meets danger, and only the fearless thrive.</h3>
            <h4>Take a look around. You might find more than you expected.</h4>
            <h2>Stay fierce, Andrea Mesa</h2>
        </div>
    );
};
