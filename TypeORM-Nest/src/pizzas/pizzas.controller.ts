...
export class PizzasController {
  ...
  async addIngredient(@Param('pizzaID') pizzaID: string, @Param('IngredientID') IngredientID: string) {
    return this.pizzasService.addIngredientToPizza(pizzaID, IngredientID);
  }
}
